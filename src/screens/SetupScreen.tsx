...
export default function SetupScreen({
  ...
  function goToConfig() {
    if (!configTouched || game.validate(players.length, config)) setConfig(game.suggest(players.length))
    onStep('config')
  }
    ...
    <OpenSettings.Provider value={() => setSettings(true)}>
      <div className="app">
        ...
        <div className="content fade-step" key={step}>
          ...
          <ScoringEditor games={[game]} label="Points par victoire" scoring={scoring} onChange={setScoring} />
